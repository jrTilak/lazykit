  ...
  "useObserve": {
    ...
    "examples": {
      "observe": {
        ...
        "code": {
          "tsx": "import React, { useRef } from 'react';\nimport useObserve from '.';\n\nconst ExampleComponent = () => {\n  const ref = useRef<HTMLDivElement>(null);\n\n  const { position, isIntersecting, enable, disable } = useObserve(ref, {\n    once: true,\n    autoEnable: true,\n    threshold: 0.5, // Trigger when 50% of the element is in the viewport\n    onIntersect: () => console.log('Element is intersecting!'),\n    onLeave: () => console.log('Element has left the viewport!'),\n  });\n\n  return (\n    <div>\n      <div style={{ height: '1500px' }}>Scroll down to observe the box.</div>\n\n      <div\n        ref={ref}\n        style={{\n          height: '100px',\n          background: isIntersecting ? 'green' : 'red',\n          transition: 'background 0.3s',\n        }}\n      >\n        {isIntersecting ? 'Visible' : 'Hidden'}\n      </div>\n\n      <div style={{ height: '1500px' }}>Scroll down to observe more.</div>\n\n      <button onClick={enable}>Enable Observer</button>\n      <button onClick={disable}>Disable Observer</button>\n    </div>\n  );\n};\n\nexport default ExampleComponent;\n"
        }
      }
    },
    "category": "web-api",
